...
export class RestaurantCommandesComponent implements OnInit {
  ...
  chargeRestaurant(){
    this.restaurant._id = localStorage.getItem('id_utilisateur');
  }
  ...
  loadCommandesEnCours(){
    ...
    this.restaurantService.findCommmandesEnCours(this.pageNumber, this.restaurant._id).subscribe(onSuccess, onError);
  }
