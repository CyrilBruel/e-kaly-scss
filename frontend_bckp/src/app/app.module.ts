...
@NgModule({
  declarations: [AppComponent, ...APP_CONTAINERS, ClientComponent, RestaurantComponent, LivreurComponent, InscriptionComponent, ClientPlatComponent, ConnexionComponent, EKalyComponent, ClientDetailsPlatComponent, RestaurantCommandesComponent, RestaurantPlatsComponent, DefaultLayoutComponent, DefaultFooterComponent, DefaultHeaderComponent, ],
  imports: [
    CommonModule,
    BrowserModule,
